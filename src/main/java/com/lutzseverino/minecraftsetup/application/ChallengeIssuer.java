...
public final class ChallengeIssuer {
    ...
    public ChallengeIssuer(
        ...
        if (timeToLive.isNegative() || timeToLive.isZero() || timeToLive.compareTo(Duration.ofMinutes(15)) > 0) {
