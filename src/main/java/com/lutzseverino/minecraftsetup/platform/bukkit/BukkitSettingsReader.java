...
public final class BukkitSettingsReader {
    ...
    public SetupPublisherSettings read() {
        ...
        SetupPublisherSettings.HttpSettings http = new SetupPublisherSettings.HttpSettings(
        ...
        SetupPublisherSettings.GateSettings gate = new SetupPublisherSettings.GateSettings(
        ...
        SetupPublisherSettings.MessageSettings messages = new SetupPublisherSettings.MessageSettings(
